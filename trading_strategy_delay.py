...
if __name__ == "__main__":
    ...
    # TODO: change dates
    date_ranges = [('1962-01-01', '1962-12-31'), ('1963-01-01', '1963-12-31'), ('1964-01-01', '1964-12-31'), ('1965-01-01', '1965-12-31'), ('1966-01-01', '1966-12-31'), ('2000-01-01', '2000-12-31'), ('2001-01-01', '2001-12-31'), ('2002-01-01', '2002-12-31'), ('2003-01-01', '2003-12-31'), ('2004-01-01', '2004-12-31'), ('2018-01-01', '2018-12-31'), ('2019-01-01', '2019-12-31'), ('2020-01-01', '2020-12-31'), ('2021-01-01', '2021-12-31'), ('2022-01-01', '2022-12-31'), ('2023-01-01', '2023-12-31')] 
    for (formation_start, formation_end) in date_ranges:
        # ---LOAD THE CSV FILE ---
        
        # TODO: CHANGE FILEPATH if needed
        pair_file = f'trading_delay/total_matched_pairs/matched_pairs_{formation_start}_{formation_end}.csv'
        ...
        # TODO: I changed it to load local data if already pulled before. it should be faster. 
        ...
        try:
            ...
            print(f"Loaded CRSP data from {formation_data_file}")
        ...
        try:
            ...
            print(f"Loaded CRSP data from {trading_data_file}")
        except FileNotFoundError:
            print("Fetching CRSP data from WRDS")
        ...
        if results:
            ...
            top_20_df.to_csv(f'to_upload/trading_strategy/top_20_pairs_with_dates_{trading_start}_{trading_end}.csv', index=False)
            ...
            summary_df.to_csv(f'to_upload/trading_strategy/top_20_pairs_summary_{trading_start}_{trading_end}.csv', index=False)
